  ...
  return (
    <div className="p-4 border rounded shadow">
      <div className="flex justify-between items-center w-50">
        <h2 className="text-lg font-bold truncate max-w-[150px]" title={competition.competitors[0].team.displayName}>
          {competition.competitors[0].team.displayName}
        </h2>
        <h2 className="font-mono">{competition.competitors[0].score}</h2>
      </div>
      <div className="flex justify-between items-center w-50">
        <h2 className="text-lg font-bold truncate max-w-[150px]" title={competition.competitors[1].team.displayName}>
